...
<%
	...
	1.1 Tomcat(내장 객체 보유) : 클라이언트가 요청 보내면 : 요청 한건에 대해서 서버는 request 객체 자동 생성
	>>>>> HttpServletRequest request = new HttpServletRequest(); ... 자동 코드 생성 >>>>>
	1.2 자동 생성된 requet 객체는 클라이언트의 다양한 정보를 담는다. : 다양한 정보(입력 데이터 + ip + 브라우저 정보)
	...
	*/
	...
	get방식 (한글깨짐) : http://localhost:8090/WebJSP/Ex02_register.jsp?userid=shpark010&pwd=1004&hobby=baseball&hobby=soccer&hobby=basketball
