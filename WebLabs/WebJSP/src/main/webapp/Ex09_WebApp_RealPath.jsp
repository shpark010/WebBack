...
이클립스 톰켓 내장
실제 배포 경로 :
C:\Duzon\Web\WebBack\WebLabs\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WebJSP
------------------------------------------------------------------->
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	//실제 배포 경로
	//C:\Duzon\Web\WebBack\WebLabs\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WebJSP\WebJSP

	String filepath = application.getRealPath(resourcepath); //
	out.print("file real path 실제 경로 : " + filepath + "<br>");
	// C:\Duzon\Web\WebBack\WebLabs\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WebJSP\download\note.txt

	//실제 개발 소스 경로
	//C:\Duzon\Web\WebBack\WebLabs\WebJSP\src\main\webapp\download\note.txt	
